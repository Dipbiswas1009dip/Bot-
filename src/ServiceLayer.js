module.exports = class ServiceLayer {
  ...
  static async readMessage(sock, msg) {
    ...
    if (sock && msg_txt && msg_destinatary) {
      ...
      this.analyseMessage(sock, msg_txt, msg_destinatary, msg);
    }
  }

  static async analyseMessage(sock, msg_txt, msg_destinatary, msg) {
    // Adding auto-reaction for all incoming messages using sendMessage with react property
